...
businessRouter.post("/opportunities", requirePerm("content:write"), (req, res) => {
...
businessRouter.post("/projects", requirePerm("content:write"), (req, res) => {
...
businessRouter.post("/evidence", requirePerm("content:write"), (req, res) => {
...
businessRouter.post("/pipelines/:type/run", requirePerm("content:write"), (req, res) => {
...
businessRouter.patch("/pipelines/:id", requirePerm("content:write"), (req, res) => {
