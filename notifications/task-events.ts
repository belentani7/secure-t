...
export function taskEvent(taskId: string, type: TaskState, details: Omit<TaskEvent, "taskId" | "type" | "occurredAt"> = {}): TaskEvent { return { ...details, taskId, type, occurredAt: new Date().toISOString() }; }
