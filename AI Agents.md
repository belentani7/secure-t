...
| proctor | exam_supervisor | read_submission, propose_assessment |
| mentor | guide | read_course, create_recommendation |
| analyst | data_analyzer | read_lab, read_lab_output |
| moderator | forum_moderator | read_course, create_hint |
| reviewer | grader | read_submission, propose_assessment |
| contributor | resource_contributor | read_course |
| observer | audit_observer | read_course |
