...
El directorio [`open-data/`](open-data/) trae un pack abierto de datos de **vulnerabilidades explotadas (CISA KEV)** (fuente publica, sin clave de API).
...
- [OWASP SecureTea](https://github.com/OWASP/SecureTea-Project)
